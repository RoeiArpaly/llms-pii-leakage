"""Attack effectiveness against Qwen Guard 0.6B.

Run independently to avoid OOM:
    uv run pytest tests/test_detectors/test_attack_effectiveness/test_qwen_guard_0_6b.py -s -v
"""
import pytest

from .conftest import ATTACK_IDS, fmt, run_model

MODELS = ["qwen-guard-0.6b", "qwen-guard-0.6b-defend"]
