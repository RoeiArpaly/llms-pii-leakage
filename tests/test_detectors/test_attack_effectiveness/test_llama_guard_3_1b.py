"""Attack effectiveness against Llama Guard 1B.

Run independently to avoid OOM:
    uv run pytest tests/test_detectors/test_attack_effectiveness/test_llama_guard_3_1b.py -s -v
"""
import pytest

from .conftest import ATTACK_IDS, fmt, run_model

MODELS = ["llama-guard-3-1b", "llama-guard-3-1b-defend"]
